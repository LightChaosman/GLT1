...
public class PlatoonItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatoonPackage.Literals.PLATOON__LEADER);
			childrenFeatures.add(PlatoonPackage.Literals.PLATOON__FOLLOWERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlatoonPackage.Literals.PLATOON__LEADER,
				 PlatoonFactory.eINSTANCE.createLeadVehicle()));

		newChildDescriptors.add
			(createChildParameter
				(PlatoonPackage.Literals.PLATOON__FOLLOWERS,
				 PlatoonFactory.eINSTANCE.createFollowVehicle()));
	}
