...
/**
 * This is the item provider adapter for a {@link platoon.Route} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RouteItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatoonPackage.Literals.ROUTE__STEPS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Route.class)) {
			case PlatoonPackage.ROUTE__NAME:
				...
				return;
			case PlatoonPackage.ROUTE__STEPS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlatoonPackage.Literals.ROUTE__STEPS,
