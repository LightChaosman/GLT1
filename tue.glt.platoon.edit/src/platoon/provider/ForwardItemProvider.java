...
/**
 * This is the item provider adapter for a {@link platoon.Forward} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForwardItemProvider extends StepItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Forward_distance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Forward_distance_feature", "_UI_Forward_type"),
				 PlatoonPackage.Literals.FORWARD__DISTANCE,
				 true,
				 false,
				 false,
