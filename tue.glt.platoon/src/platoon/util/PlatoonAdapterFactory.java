...
public class PlatoonAdapterFactory extends AdapterFactoryImpl {
	...
	protected PlatoonSwitch<Adapter> modelSwitch =
		new PlatoonSwitch<Adapter>() {
			...
			@Override
			public Adapter caseLeadVehicle(LeadVehicle object) {
				return createLeadVehicleAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseheadway(headway object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link platoon.LeadVehicle <em>Lead Vehicle</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLeadVehicleAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link platoon.headway <em>headway</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createheadwayAdapter() {
		return null;
	}
