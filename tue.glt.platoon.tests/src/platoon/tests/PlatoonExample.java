...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>platoon</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class PlatoonExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(PlatoonPackage.eNS_URI, 
			 PlatoonPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				...
				World root = PlatoonFactory.eINSTANCE.createWorld();
